...
class Info {
    public static FnDeclNode currentFuncNode = null;
    public static int visitedFormalCount = 0;
    public static int visitedLocalCount = 0;
    public static boolean isMainFunction = false;
}
...
class FormalsListNode extends ASTnode {
    ...
    public List<Type> nameAnalysis(SymTable symTab) {
        ...
        for (FormalDeclNode node : myFormals) {
            ...
            sym.isLocal = true;
            sym.localOffset = 4*(++Info.visitedFormalCount);
            if (sym != null) {
...
class VarDeclNode extends DeclNode {
    ...
    public Sym nameAnalysis(SymTable symTab, SymTable globalTab) {
        ...
        if (Info.currentFuncNode == null) {
            sym.isLocal = false;
            sym.globalLabel = "_" + name;
        } else {
            sym.isLocal = true;
            sym.localOffset = -8-4*(Info.visitedLocalCount++);
        }
    ...
    public void codeGen() {
        if (!myId.sym().isLocal) {
            ...
            Codegen.generateLabeled(myId.sym().globalLabel, ".space 4", "");
            Codegen.generate(".text");
        }
    }
...
class FnDeclNode extends DeclNode {
     ...
     */
    public Sym nameAnalysis(SymTable symTab) {
        Info.visitedLocalCount = 0;
        Info.visitedFormalCount = 0;
        Info.currentFuncNode = this;
        ...
        localTotalSize = Info.visitedLocalCount * 4;
        Info.visitedLocalCount = 0;
        Info.visitedFormalCount = 0;
        Info.currentFuncNode = null;
        return null;
    }
    ...
    public void codeGen() {
        ...
        if ("main".equals(myId.name())) {
            Info.isMainFunction = true;
            Codegen.genLabel("__start");
        }
        Codegen.genPush(Codegen.RA);
        Codegen.genPush(Codegen.FP);
        Codegen.generate("addu", Codegen.FP, Codegen.SP, 8);
        Codegen.generate("subu", Codegen.SP, Codegen.SP, getLocalTotalSize());
        myBody.codeGen();
...
class PostIncStmtNode extends StmtNode {
    ...
    public void codeGen() {
        Codegen.loadSymAddressIntoT0((IdNode)myExp);
...
class ReadStmtNode extends StmtNode {
    ...
    public void codeGen() {
        ...
        Codegen.generateWithComment("syscall", "Read Integer into V0");
...
class IfStmtNode extends StmtNode {
    ...
    public void codeGen() {
        myExp.codeGen();
        String ifEndLabel = Codegen.nextLabel();

        Codegen.genPop(Codegen.T0);
        Codegen.generate("beq", Codegen.T0, Codegen.R0, ifEndLabel);
        myStmtList.codeGen();
        Codegen.genLabel(ifEndLabel);
    }
...
class IfElseStmtNode extends StmtNode {
    ...
    public void codeGen() {
        myExp.codeGen();
        String ifElseLabel = Codegen.nextLabel();
        String ifEndLabel = Codegen.nextLabel();

        Codegen.genPop(Codegen.T0);
        Codegen.generate("beq", Codegen.T0, Codegen.R0, ifElseLabel);
        myThenStmtList.codeGen();
        Codegen.generate("b", ifEndLabel);
        Codegen.genLabel(ifElseLabel);
...
class WhileStmtNode extends StmtNode {
    ...
    public void codeGen() {
        String whileBeginL = Codegen.nextLabel();
        String whileEndL = Codegen.nextLabel();

        Codegen.genLabel(whileBeginL);
        myExp.codeGen();
        Codegen.genPop(Codegen.T0);
        Codegen.generate("beq", Codegen.T0, Codegen.R0, whileEndL);

        myStmtList.codeGen();
        Codegen.generate("b", whileBeginL);
        Codegen.genLabel(whileEndL);
    }
...
class ReturnStmtNode extends StmtNode {
    ...
    public void codeGen() {
        ...
        if (Info.isMainFunction) {
            Codegen.generate("li", Codegen.V0, 10);
            Codegen.generate("syscall");
        } else {
            Codegen.generate("add", Codegen.SP, Codegen.FP, "0");
            Codegen.generateIndexed("lw", Codegen.FP, Codegen.SP, -4);
...
class IdNode extends ExpNode {
    ...
    public void unparse(PrintWriter p, int indent) {
        p.print(myStrVal);
        if (mySym != null) {
            p.print("(" + mySym + "," + (mySym.isLocal?mySym.localOffset:mySym.globalLabel) +")");
        }
    }

    public void codeGen() {
        Codegen.loadSymValIntoT0(this);
        Codegen.genPush(Codegen.T0);
    }
...
class AssignNode extends ExpNode {
    ...
    public void codeGen() {
        ...
        Codegen.loadSymAddressIntoT0((IdNode) myLhs);
        Codegen.generateIndexed("sw", Codegen.T1, Codegen.T0, 0);
    }
...
class CallExpNode extends ExpNode {
    ...
    public void codeGen() {
        ...
        Codegen.generate("addi", Codegen.SP, Integer.toString(4*myExpList.size()));

        FnSym sym = (FnSym)(myId.sym());
        if (sym.getReturnType().isVoidType() == false) {
...
abstract class BinaryExpNode extends ExpNode {
    ...
    public void codeGen() {
        ...
        Codegen.generate(operator(), Codegen.T0, Codegen.T1, Codegen.T2);
        Codegen.genPush(Codegen.T0);
    }
...
class UnaryMinusNode extends UnaryExpNode {
    ...
    public void codeGen() {
        myExp.codeGen();
        Codegen.genPop(Codegen.T0);
        Codegen.generate("sub", Codegen.T0, Codegen.R0, Codegen.T0);
        Codegen.genPush(Codegen.T0);
    }
}
...
abstract class EqualityExpNode extends BinaryExpNode {
    ...
    public void codeGen() {
        ...
        if (myExp1 instanceof StringLitNode && myExp2 instanceof StringLitNode) {
            Codegen.generateWithComment("add", "pop unused", Codegen.SP, Codegen.SP, "8");
            if (((StringLitNode)myExp1).strVal().equals(((StringLitNode)myExp2).strVal())) {
                Codegen.generateWithComment("move", "force t0==t1", Codegen.T0, Codegen.T1);
            } else {
                Codegen.generateWithComment("add", "force t0!=t1", Codegen.T0, Codegen.T1, "1");
            }
        ...
        Codegen.generate(operator(), Codegen.T0, Codegen.T1, l);
        Codegen.generateWithComment("li", "Force to 0 when condition not satisfied", Codegen.T2, "0");
        Codegen.genLabel(l);
...
abstract class RelationalExpNode extends BinaryExpNode {
    ...
    public void codeGen() {
        ...
        String l = Codegen.nextLabel();
        Codegen.generate("li", Codegen.T0, "1");
        Codegen.generate(operator(), Codegen.T1, Codegen.T2, l);
        Codegen.generateWithComment("li", "Force to 0", Codegen.T0, "0");
        Codegen.genLabel(l);
        Codegen.genPush(Codegen.T0);
    }
...
class AndNode extends LogicalExpNode {
    ...
    public void codeGen() {
        ...
        Codegen.generate("beq", Codegen.T0, Codegen.R0, l);
        Codegen.generate("add", Codegen.SP, Codegen.SP, "4");
        myExp2.codeGen();
        Codegen.genLabel(l);
    }
}
...
class OrNode extends LogicalExpNode {
    ...
    public void codeGen() {
        ...
        String l = Codegen.nextLabel();
        Codegen.generateIndexed("lw", Codegen.T0, Codegen.SP, 4);
        Codegen.generate("bne", Codegen.T0, Codegen.R0, l);
        Codegen.generate("add", Codegen.SP, Codegen.SP, "4");
        myExp2.codeGen();
        Codegen.genLabel(l);
    }
